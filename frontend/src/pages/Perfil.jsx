    ...
    <div className="inicio-page">
      <header className="inicio-header">
        ...
        <div className="header-user">
          <span>Hola, {datosPerfil.nombres}</span>
      ...
      <main className="inicio-container">
        <section className="inicio-intro">
          ...
          <p>Consulta tu historial académico, actualiza tus datos y busca otros estudiantes.</p>
        </section>
        ...
        <section className="filtros-panel" style={{ marginBottom: '24px' }}>
          ...
          <div className="filtros-grid" style={{ marginTop: '16px' }}>
            <div className="filtro-grupo">
              <label>Carnet / Registro Académico</label>
              <input type="text" value={datosPerfil.carnet} disabled />
            </div>
            <div className="filtro-grupo">
          ...
          <button type="button" className="limpiar-button" style={{ marginTop: '16px', background: '#1c3b70', color: '#fff' }}>
            Guardar cambios
          </button>
        </section>
        ...
        <section className="filtros-panel">
          ...
          <form onSubmit={handleBuscar} style={{ display: 'flex', gap: '10px', marginTop: '14px', marginBottom: '14px' }}>
            ...
            />
            <button type="submit" className="limpiar-button" style={{ background: '#1c3b70', color: '#fff' }}>
              Consultar
            </button>
          </form>
